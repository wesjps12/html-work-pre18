	...
	<body>
		<div id="page">
			<header id="header">
				<div id="header-inner">	
					<div id="logo">
						<h1><a href="#">Native Land <span>Development</span></a></h1>
					</div>
					<div id="top-nav">
						<ul>
            ...
            <h2> top </h2>
                ...
                <li><a href="#">Working With Tribes</a></li>
                <li><a href="#">Credentials</a></li>
                <li><a href="#">Contact Us</a></li>
                <li><a href="#">Current Projects</a></li>
                <li><a href="#">Residential</a></li>
                <li><a href="#">Commercil</a></li>
                <li><a href="#">Deconstruction & restoration</a></li>
                <li><a href="#">Specialty Subcontracting</a></li>
							</ul>
						</div>
					</nav>
			...
			<div id="footerblurb">
				<div id="footerblurb-inner">
					...
					<div class="column">
					<h2><span><p><a href="#" style="color: #228B22">About Us</a></p></span></h2>
						<p>test</p>
					</div>	
					<div class="column">
				  <h2><span><p><a href="#" style="color: #228B22">Contact</a></p></span></h2>
						<p>test</p>
					</div>
					<div class="column">
          <h2><span><p><a href="#" style="color: #228B22">About Us</a></p></span></h2>
